...
public class GravesLSTMCharModellingExample {
	...
	public void start(CharacterIterator iter) throws Exception {
	 ...
	 */
	public CharacterIterator getCharacterIterator(int miniBatchSize, int sequenceLength,File f) throws Exception{
