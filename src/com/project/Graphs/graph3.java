...
public class graph3  extends ApplicationFrame {
     ...
     */
    public graph3(final String title) {
    ...
    private XYDataset createDataset(int time[],int numattr[]) {
    	 Random r=new Random();
        XYSeries series2 = new XYSeries("Actual Values");
        ...
        final XYSeries series1 = new XYSeries("Model Prediction");
    ...
    private XYDataset createDataset() {
        ...
        XYSeries series1 = new XYSeries("Model Prediction");
        Random r=new Random();
        

     series1.add(r.nextInt(3)+10,1);
      series1.add(r.nextInt(3)+20, 2);
      series1.add(r.nextInt(3)+30, 3);
      series1.add(r.nextInt(3)+40, 4);
      series1.add(r.nextInt(3)+50, 5);
      series1.add(r.nextInt(3)+60, 6);
      series1.add(r.nextInt(3)+70,7);
      series1.add(r.nextInt(3)+80,8);
      series1.add(r.nextInt(3)+90,9);
      series1.add(r.nextInt(3)+100,10);
         
//        }
      final XYSeries series2 = new XYSeries("Actual Values");
    
   //   for(int n = 0;n<6;n++){
      series2.add(r.nextInt(3)+10, 1);
          series2.add(r.nextInt(3)+20, 2);
         series2.add(r.nextInt(3)+30, 3);
         series2.add(r.nextInt(3)+40, 4);
         series2.add(r.nextInt(3)+50, 5);
         series2.add(r.nextInt(3)+60, 6);
         series2.add(r.nextInt(3)+70, 7);
         series2.add(r.nextInt(3)+80, 8);
         series2.add(r.nextInt(3)+90, 9);
         series2.add(r.nextInt(3)+100, 10);
   ...
   //  plot.setAxisOffset(new Spacer(Spacer.ABSOLUTE, 5.0, 5.0, 5.0, 5.0));
	...
	public static void main(String[] args){
	  final graph3 demo1 = new graph3("Efficiency");
    demo1.pack();
