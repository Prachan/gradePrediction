  ...
  ================================================== -->
        ...
        <script>
            ...
            function reg_check()
            {
                ...
                var mobno = document.getElementById("cnum").value;
    ...
    <div class="service" id="service">
        <div class="container">
                ...
                <center> 
                    <h2 class="white">REGISTER YOURSELF</h2>
                    <hr class="white">

                    <form onsubmit="return reg_check();" action="./Register" method="post">
                        <table>
                            <tr> <td><input type="text" name="sname" id ="sname" required="" placeholder="Student Name:" /></td></tr>
                            <tr><td><textarea name="addr" required="" placeholder="Address:"></textarea></td></tr>
                            <tr><td><input type="text" name="cnum" id ="cnum" required="" placeholder="Contact Number:"/></td></tr>
                            <tr><td><input type="text" name="email" id ="email" required="" placeholder="Email Address:"/></td></tr>
                            <tr><td><input type="password" name="pass" id ="pass" required="" placeholder="Password:"/></td></tr>
                            <tr><td><input type="password" name="cpass" id ="cpass" required="" placeholder="Password(Confirm)"/></td></tr>                           
