...
<div class="service" id="service">
    <div class="container">
        ...
        <div class="sixteen columns">
         ...
         <center>   <h2 class="white">Add Product</h2>
         <hr class="white">
         
         <form method="POST" action="Controller?task=add_product">
           <table>
                 <tr><td><input type="text" name="pname" id="pname" placeholder="Product Name:"/></td></tr>
                 <tr><td><input type="text" name="quantity" id="quantity" placeholder="Quantity:"/></td></tr>
                 <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Insert"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" value="Clear"/></td></tr>
             </table>
         </form>
