  ...
  ================================================== -->
                ...
                <div class="thirteen columns navigation">
                    <nav>
                        <div class='rmm' data-menu-style = "minimal">
                            <ul>
                                <li><a href='admin_home.jsp'>HOMEPAGE</a></li>
                                <li><a href='Controller?task=admin_user_view'>VIEW USER</a></li>
    ...
    <div class="service" id="service">
        <div class="container">
            ...
            <center><h2 class="white">User Details</h2>
                <hr class="white">
                <p class="white center">
                    <script>
                        function change_status(i)
                        {
                            ...
                            var sta = $('#sta'+i).val();
                            xhttp.open("POST", "Controller?task=update_user_status&email="+email+"&sta="+sta, true);
                            xhttp.send();
                        }
                ...
                <table style="width: 50%;">
                    <tr style="border: 1px solid black"><td style="border: 1px solid black"><strong>Email</strong></td><td style="border: 1px solid black"><strong>Status</strong></td><td style="border: 1px solid black"><strong>Action</strong></td></tr>
                    <%
                    ...
                    <input type="hidden" name="email<%=i%>" id="email<%=i%>" value="<%=a[0]%>"/>
                    <input type="hidden" name="sta<%=i%>" id="sta<%=i%>" value="<%=a[1]%>"/>
                    <% if (a[1].equalsIgnoreCase("active")) {%>
                    <td style="border: 1px solid black"><input type="button" value="Inactive" onclick="return change_status(<%=i%>)"/></td>
                        <%} else if (a[1].equalsIgnoreCase("inactive")) {%>
                    <td style="border: 1px solid black"><input type="button" value="Active" onclick="return change_status(<%=i%>)"/></td>
                        <%}%>
                    </tr>
                    <%
                        }
